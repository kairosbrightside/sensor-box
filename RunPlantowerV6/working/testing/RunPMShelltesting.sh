...
PlantowerScript1='/home/pi/RunPlantower/working/testing/PMSX003Version1v3.py'
PlantowerScript2='/home/pi/RunPlantower/PMS5003stVersion1v3.py'
...
/usr/bin/python3.5 $PlantowerScript1 "${SITE[@]}" "${SNPortPair[(i*2)]}" "${SNPortPair[(i*2)+1]}" & 
/usr/bin/python3.5 $PlantowerScript2 "${SITE[@]}" "${SNPortPair[(i*2)]}" "${SNPortPair[(i*2)+1]}" & 
