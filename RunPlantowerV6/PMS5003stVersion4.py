...
# The script is broken into 10 sections:
##(0) import libraries 
##(1) inputs for shell
##(2) make a log file
##(3) define functions
...
##(6) check zero
##(7) establish RPi-plantower serial connection 
##(8-10) read plantower data, aggregate, and write to disk

# updated 9DEC2020 by AWF
#########################################  
#(0) libraries
##########################################
import os, sys
